...
\title{Magični kvadrati} \date{\today}
% 1. naloga
...
\section{Uvod}
\begin{definicija}
   \textcolor{magenta}{\emph{Magični kvadrat}} reda $n$ je nabor $n^2$ različnih števil,
...
\begin{definicija}
   Magični kvadrat reda $n$ je \textcolor{magenta}{\emph{normalen}}, če v njem nastopajo števila
   \begin{equation}{numbers}
      \label{eq:numbers}
...
\textcolor{magenta}{\emph{Lo Shu}} -- ">zvitek reke Lo"<. V antični Kitajski je prišlo do
...
\textcolor{magenta}{\emph{Kubera-Kolam}} je talna poslikava, ki se uporablja v Indiji, in je v
...
\begin{definicija}
      ...
      v magičnem kvadratu imenujemo \textcolor{magenta}{\emph{magična konstanta}}.
\end{definicija}
\begin{table}
    \caption{Pasijonska fasada, Sagrada Família}
   \label{table:sagrada}
